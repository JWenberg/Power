	...
	: FApplicationMode(FAblAbilityEditorModes::AbilityTimelineMode, FAblAbilityEditorModes::GetLocalizedMode)
{
	...
	TabLayout = FTabManager::NewLayout("Ability_AbilityTimelineEditMode_Layout_v8")
		->AddArea
		(
	...
	: FBlueprintEditorApplicationMode(StaticCastSharedPtr<FBlueprintEditor>(AbilityEditor), FAblAbilityEditorModes::AbilityBlueprintMode, FAblAbilityEditorModes::GetLocalizedMode, false, false)
{
	...
	ToolbarExtender = MakeShareable(new FExtender);
	AbilityEditor->GetToolbarBuilder()->AddCompileToolbar(ToolbarExtender);
	AbilityEditor->GetToolbarBuilder()->AddScriptingToolbar(ToolbarExtender);
	AbilityEditor->GetToolbarBuilder()->AddBlueprintGlobalOptionsToolbar(ToolbarExtender);
	AbilityEditor->GetToolbarBuilder()->AddDebuggingToolbar(ToolbarExtender);
}
