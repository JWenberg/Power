...
#endif
		UAblAbility* BranchToAbility = m_DynamicBranchAbility ? Context->GetAbility()->OnGetBranchAbilityBP(Context.Get(), m_DynamicBranchEventName) : Cast<UAblAbility>(m_BranchAbility->GetDefaultObject());
		if (BranchToAbility)
		{
