...
public:
	...
	virtual FText GetTaskName() const override { return LOCTEXT("AblSetShaderParameterTask", "Set Shader Parameter"); }

	/* Returns the dynamic, descriptive name of our Task. */
	virtual FText GetDescriptiveTaskName() const override;
	
	/* Returns the description of our Task. */
	virtual FText GetTaskDescription() const override { return LOCTEXT("AblSetShaderParameterTaskDesc", "Sets a dynamic shader parameter on the Target's material instance."); }
	
	/* Returns the color of our Task. */
	virtual FLinearColor GetTaskColor() const override { return FLinearColor::Blue; }
...
private:
	...
	void InternalSetShaderValue(UMaterialInstanceDynamic* DynMaterial, UAblSetParameterValue* Value, UAblSetParameterValue* PreviousValue, float BlendAlpha) const;
